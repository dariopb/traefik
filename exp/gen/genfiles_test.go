...
func TestGenAPI(t *testing.T) {
	...
	for _, test := range testCases {
		...
		t.Run(test.desc, func(t *testing.T) {
			...
			file, err := os.Create("/home/ldez/sources/go/src/github.com/traefik/traefik/docs/content/reference/dynamic-configuration/" + test.filename)
			require.NoError(t, err)
...
func TestGenRuntime(t *testing.T) {
	...
	file, err := os.Create("/home/ldez/sources/go/src/github.com/traefik/traefik/docs/content/reference/dynamic-configuration/api_runtimeConfiguration.json")
	require.NoError(t, err)
...
// 	file, err := os.Open("/home/ldez/sources/go/src/github.com/traefik/traefik/docs/content/reference/dynamic-configuration/api_runtimeConfiguration.json")
// 	require.NoError(t, err)
//
...
// 	}
//
// 	output, err := os.Create("/home/ldez/sources/go/src/github.com/traefik/traefik/docs/content/reference/dynamic-configuration/api_middlewares.json")
// 	require.NoError(t, err)
//
